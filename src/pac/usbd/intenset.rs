...
pub type R = crate::pac::generic::R<u32, super::INTENSET>;
#[doc = "Writer for register INTENSET"]
pub type W = crate::pac::generic::W<u32, super::INTENSET>;
#[doc = "Register INTENSET `reset()`'s with value 0"]
impl crate::pac::generic::ResetValue for super::INTENSET {
    type Type = u32;
    #[inline(always)]
