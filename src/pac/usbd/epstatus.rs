...
pub type R = crate::pac::generic::R<u32, super::EPSTATUS>;
#[doc = "Writer for register EPSTATUS"]
pub type W = crate::pac::generic::W<u32, super::EPSTATUS>;
#[doc = "Register EPSTATUS `reset()`'s with value 0"]
impl crate::pac::generic::ResetValue for super::EPSTATUS {
    type Type = u32;
    #[inline(always)]
...
pub type EPIN0_R = crate::pac::generic::R<bool, EPIN0_A>;
impl EPIN0_R {
...
pub type EPIN8_R = crate::pac::generic::R<bool, EPIN8_A>;
impl EPIN8_R {
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
...
pub type EPOUT0_R = crate::pac::generic::R<bool, EPOUT0_A>;
impl EPOUT0_R {
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
...
pub type EPOUT8_R = crate::pac::generic::R<bool, EPOUT8_A>;
impl EPOUT8_R {
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
